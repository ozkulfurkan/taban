    ...
    <AppShell>
      <div className="max-w-2xl space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-slate-800">{t('customers', 'newCustomerTitle')}</h1>
        </div>

        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'companyNameLabel')}</label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('common', 'currency')} *</label>
              ...
              <p className="text-xs text-slate-400 mt-1">{t('customers', 'currencyHint')}</p>
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'taxId')}</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'taxOffice')}</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'phone')}</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'email')}</label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'address')}</label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-medium text-slate-600 mb-1">{t('customers', 'notes')}</label>
